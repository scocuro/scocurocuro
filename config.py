...
# 5) 티커별 평가일
EVALUATION_DATES = {
    '^N225':  {1:date(2026,9,18),2:date(2026, 12,22),3:date(2027,3,19),4:date(2027,6,22),5:date(2027,9,22),6:date(2027,12,22),7:date(2028,3,22),8:date(2028,6,22),9:date(2028,9,21),10:date(2028,12,22),11:date(2029,3,22)},
    '^GSPC':  {1:date(2026,9,18),2:date(2026, 12,22),3:date(2027,3,19),4:date(2027,6,22),5:date(2027,9,22),6:date(2027,12,22),7:date(2028,3,22),8:date(2028,6,22),9:date(2028,9,21),10:date(2028,12,22),11:date(2029,3,22)},
    '^KS200':  {1:date(2026,9,18),2:date(2026, 12,22),3:date(2027,3,19),4:date(2027,6,22),5:date(2027,9,22),6:date(2027,12,22),7:date(2028,3,22),8:date(2028,6,22),9:date(2028,9,21),10:date(2028,12,22),11:date(2029,3,22)},
