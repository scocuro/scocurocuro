...
UNDERLYING_TICKERS = ['^N225', '^GSPC', '^STOXX50E', '005930.KS', '005380.KS','PLTR','MU']
...
EARLY_REDEMPTION_COUPONS = {
    '^N225':    {i: 0.0880 for i in range(1,6)},
    '^GSPC':    {i: 0.0880 for i in range(1,6)},
    '^STOXX50E':{i: 0.0880 for i in range(1,6)},
...
EVALUATION_DATES = {
    ...
    '^N225':  {1:date(2026,7,9),2:date(2027, 1,8),3:date(2027,7,9),4:date(2028,1,7),5:date(2028,7,7)},
    '^GSPC':  {1:date(2026,7,9),2:date(2027, 1,8),3:date(2027,7,9),4:date(2028,1,7),5:date(2028,7,7)},
    '^STOXX50E':{1:date(2026,7,9),2:date(2027, 1,8),3:date(2027,7,9),4:date(2028,1,7),5:date(2028,7,7)},
